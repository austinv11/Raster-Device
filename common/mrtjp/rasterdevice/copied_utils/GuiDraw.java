...
/**
 * Copied DIRECTLY from CodeChickenCore to avoid direct dependency.
 * This is covered by the original license.
 * 
 * @author ChickenBones
 */
public class GuiDraw
{
    ...
    {
        RenderUtils.changeTexture(s);
    }

    public static void changeTexture(ResourceLocation r)
    {
        RenderUtils.changeTexture(r);
    }
    ...
    /**
     * Append a string in the list with "\247h" to have a small gap between it
     * and the next line
     */
    public static void drawMultilineTip(int x, int y, List<String> list)
    {
        ...
        x = (int) clip(x, 8, displaySize().width - 8 - w);
